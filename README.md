# ring-http-response [![Build Status](https://travis-ci.org/metosin/ring-http-response.svg?branch=master)](https://travis-ci.org/metosin/ring-http-response) [![Downloads](https://jarkeeper.com/metosin/ring-http-response/downloads.svg)] [![Dependencies Status](http://jarkeeper.com/metosin/ring-http-response/status.svg)](http://jarkeeper.com/metosin/ring-http-response)
